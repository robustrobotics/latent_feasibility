    ...
    for epoch in range(args.num_epochs): 
        ...
        if args.guess_obj: 
            wandb.log({
                ...
                "val/x_loss": total_loss_x / len(val_dataloader),
                "val/y_loss": total_loss_y / len(val_dataloader),
                "val/z_loss": total_loss_z / len(val_dataloader),
            })
